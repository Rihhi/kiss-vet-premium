...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kiss Állatorvosi Rendelő – Békéscsaba" },
      { property: "og:description", content: "Prémium állatorvosi ellátás családias környezetben. Több éves tapasztalat, modern eszközök." },
